...
class Config:
    ...
    TRANSCRIPTION_PROVIDER = os.getenv("TRANSCRIPTION_PROVIDER", "yandex")
    YANDEX_SPEECHKIT_API_KEY = os.getenv("YANDEX_SPEECHKIT_API_KEY")
    OPENAI_WHISPER_API_KEY = os.getenv("OPENAI_WHISPER_API_KEY")
    # URL сервера транскрибации (если используете TRANSCRIPTION_PROVIDER=server_whisper)
    WHISPER_SERVER_URL = os.getenv("WHISPER_SERVER_URL", "http://195.209.214.199:8080")
