...
class Config:
    ...
    EMBEDDING_PROVIDER = os.getenv("EMBEDDING_PROVIDER", "huggingface")  # 'openai', 'huggingface' или 'ollama'
    ...
    RAGAS_EMBEDDING_PROVIDER = os.getenv("RAGAS_EMBEDDING_PROVIDER", "huggingface")  # 'openai', 'huggingface' или 'ollama'
    @classmethod
