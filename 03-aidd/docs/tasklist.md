...
| 3        | ✅ Завершено | Интеграция с LLM     | 2025-11-29      |
| 4        | ✅ Завершено | Системный промпт     | 2025-11-29      |
| 5        | ✅ Завершено | История диалога      | 2025-11-29      |
| 6        | ✅ Завершено | Обработка ошибок     | 2025-11-29      |
...
-   [x] Настроить клиент OpenAI для работы с OpenRouter
-   [x] Реализовать функцию отправки запроса к LLM
-   [x] Добавить обработку ответа от LLM
-   [x] Интегрировать LLM в обработчик сообщений бота
...
-   [x] Добавить системный промпт "Финансовый советник"
-   [x] Настроить передачу системного промпта в LLM
-   [x] Протестировать ответы бота в контексте финансового советника
...
-   [x] Реализовать хранение истории диалога в памяти
-   [x] Добавить историю в контекст запроса к LLM
-   [x] Ограничить размер истории (последние N сообщений)
-   [x] Протестировать диалог с учетом истории
...
-   [x] Добавить обработку ошибок API (OpenRouter, Telegram)
-   [x] Реализовать таймауты для запросов к LLM
-   [x] Добавить информативные сообщения об ошибках пользователю
