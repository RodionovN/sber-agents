...
| 2 | ⏸️ Ожидание | Базовый Telegram-бот | - |
...
- [ ] Создать простой бот с aiogram (polling)
- [ ] Реализовать команду `/start`
- [ ] Реализовать обработку текстовых сообщений (эхо)
- [ ] Добавить базовое логирование
- [ ] Протестировать работу бота в Telegram
