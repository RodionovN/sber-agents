...
class Config:
    ...
    # Может быть именем модели из HuggingFace Hub или локальным путем к папке с моделью
    # Примеры: "intfloat/multilingual-e5-base" или "D:\\Documents\\Projects\\sber-agents\\models\\multilingual-e5-base"
    ...
    # Используем локальную модель из папки проекта вместо HuggingFace Hub
    # _default_cross_encoder_path = r"D:\Documents\Projects\sber-agents\models\mmarco-mMiniLMv2-L12-H384-v1\\"
